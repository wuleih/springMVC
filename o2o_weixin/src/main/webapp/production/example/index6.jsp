...
<title>jquery-mobile</title>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/ext/app.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/ext/mui.locker.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/mui.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/ext/mui.view.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/ext/feedback.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common-mui/ext/feedback-page.js"></script>
    
	<script src='${pageContext.request.contextPath}/common-mui//easymob-webim-sdk/strophe-custom-2.0.0.js'></script>
	<script src='${pageContext.request.contextPath}/common-mui//easymob-webim-sdk/json2.js'></script>
	<script src="${pageContext.request.contextPath}/common-mui//easymob-webim-sdk/easemob.im-1.0.5.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/common-mui/feedback-page.css" />
</head>
<body>
